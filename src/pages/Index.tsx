  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      stars.forEach(star => {
        ...
        // Twinkle effect
        star.alpha = Math.abs(Math.sin(Date.now() * 0.001 + star.x)) * 0.5 + 0.5;
      });
    };
    ...
    <div className="relative min-h-screen bg-[#1A1F2C] text-white overflow-hidden">
      ...
      <div className="relative bg-[#1A1F2C]/80 backdrop-blur-sm py-20 px-4 z-10">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-12 text-center text-[#9b87f5]">Особенности HilpClient</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard 
              icon="Target" 
              title="Аимбот" 
              description="Автоматическое наведение на противников для точных ударов каждый раз."
            />
            <FeatureCard 
              icon="Eye" 
              title="ESP" 
            ...
            <FeatureCard 
              icon="ArrowUp" 
              title="Fly/Jump" 
              description="Летайте или совершайте невероятные прыжки с индивидуальной настройкой."
            />
            <FeatureCard 
              icon="Settings" 
              title="Кастомизация" 
              description="Полностью настраиваемый интерфейс и параметры функций."
            />
          </div>
        </div>
      </div>
      ...
      <div className="relative py-20 px-4 z-10 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-12 text-center text-[#9b87f5]">HilpClient в действии</h2>
          ...
          <div className="relative h-80 md:h-[500px] w-full rounded-2xl overflow-hidden border-2 border-[#7E69AB]/50 shadow-lg shadow-[#9b87f5]/30">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-8 backdrop-blur-lg bg-black/20 rounded-lg">
                <Icon name="Image" size={80} className="mx-auto mb-4 text-[#9b87f5]" />
                <p className="text-lg text-white">Скриншот интерфейса HilpClient</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative py-20 px-4 z-10 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-6 text-[#9b87f5]">Готовы поднять свою игру на новый уровень?</h2>
      ...
      <footer className="relative z-10 bg-black/50 backdrop-blur-md text-center py-6">
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-gray-400 text-sm">
            © 2025 HilpClient. Все права защищены. Этот продукт предназначен исключительно для образовательных целей.
          </p>
        </div>
      </footer>
    </div>
